 ...
 */
export function is_own_echo(queued: string, incoming: string): boolean;

/**
 * `on_ack(local: LocalRow, ack: WriteAck) -> AckOutcome`
 */
export function on_ack(local: string, ack: string): string;

/**
 * `reconcile(local?: LocalRow, incoming: ChangeEvent) -> Reconcile`
 */
export function reconcile(local: string | null | undefined, incoming: string): string;
